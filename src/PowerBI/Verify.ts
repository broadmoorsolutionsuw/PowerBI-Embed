...
export const validateEmbedTokenRequest = (
  ...
  // Validate datasetIds is an array
  ...
  // Validate datasetIds are non-empty strings
  ...
  if (roles?.includes('MDG_Number')) {
    // For MDG_Number role, username should be 6-10 digits
    ...
    // For MDG role, validate format like "994US30"
